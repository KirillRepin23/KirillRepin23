# Настоящий скрипт выгружает данные из Appmetrica об установках
...
def send_request(application_id: str,
    ...
    ''' 
      Функция, в которой отправляется GET запрос к API Appmetrica (installations) с требованием 
    ...
    if df1.shape[0] == 0:
      ...
      df_rec = df1.query("is_reattribution=='false'")
...
bq_table_id = 'holodilnik-bq-376311.appmetrica_dashboard.installs'
